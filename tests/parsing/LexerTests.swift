...
class LexerTests: Test {
    ...
    static func testBasic() throws {
        ...
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 13, column: 6))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 14, column: 5))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 15, column: 5))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "build.osx", line: 15, column: 6))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.OpenBrace, value: "{", line: 15, column: 16))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 15, column: 17))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 16, column: 7))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "tool", line: 16, column: 8))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "lldb-build", line: 16, column: 13))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 16, column: 25))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 17, column: 7))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "name", line: 17, column: 8))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "json-swift-osx", line: 17, column: 13))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 17, column: 29))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 18, column: 7))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "name.short", line: 18, column: 8))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "js-osx", line: 18, column: 19))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 18, column: 27))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 19, column: 7))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "output-type", line: 19, column: 8))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "lib", line: 19, column: 20))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 19, column: 26))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Colon, value: ":", line: 20, column: 7))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Identifier, value: "sources", line: 20, column: 8))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.OpenBracket, value: "[", line: 20, column: 16))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "src/**.swift", line: 20, column: 17))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.StringLiteral, value: "lib/**.swift", line: 20, column: 32))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.CloseBracket, value: "]", line: 20, column: 46))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 20, column: 47))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.CloseBrace, value: "}", line: 21, column: 5))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 21, column: 6))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.CloseBrace, value: "}", line: 22, column: 3))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 22, column: 4))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.CloseParen, value: ")", line: 23, column: 1))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 23, column: 2))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Terminal, value: "\n", line: 24, column: 1))
        try test.assert(lexer.next() == Token(type: atpkg.TokenType.Comment, value: " End of the sample.", line: 25, column: 1))
